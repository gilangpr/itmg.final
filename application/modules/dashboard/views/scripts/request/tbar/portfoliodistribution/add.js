...
Ext.create('Ext.Window', {
	title: 'Add New Portfolio Distribution',
	draggable: false,
	modal: true,
	width: 500,
	resizable: false,
	items: [{
		...
		items: [{
			...
			id: 'portfoliodistribution-add-form',
			waitMsgTarget: true,
			items: [{
					xtype: 'combobox',
	...
	buttons: [{
		...
		listeners: {
			click: function() {
				...
				var store = loadStore('Portfoliodistribution');
				if(form.isValid()) {
					form.submit({
						url: sd.baseUrl + '/portfoliodistribution/request/create',
